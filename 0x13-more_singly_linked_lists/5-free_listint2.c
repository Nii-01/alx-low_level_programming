...
and frees the memory for each node one by one until it reaches the end of the list. After
all the memory has been freed, it sets the @head pointer to NULL to indicate that the list
is empty
