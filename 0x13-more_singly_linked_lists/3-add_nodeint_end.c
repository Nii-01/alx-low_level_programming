...
This function creates a new node with the given integer value @n and adds it to the end of
the linked list pointed to by @head. If @head is NULL, a new list is created with the new
node as the first (and only) element
 *
